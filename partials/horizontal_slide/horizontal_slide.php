<main id="content" class="site-content" role="main">
    <section id="panels">
        <div id="panels-container" style="width: 500%;">
            <article id="panel-1" class="w-100 h-100 bg-dark">
                <div class="panel">
            ...
            <article id="panel-2" class="w-100 h-100 bg-dark">
                <div class="panel">
                    <div class="bg-image w-100 h-100">
                        <div class="gradient flex-column d-flex justify-content-center align-items-center w-100 h-100">
                            <div class="text-center text-light col-12 col-md-10 py-5">
            ...
            <article id="panel-3" class="w-100 h-100 bg-dark">
                <div class="panel">
                    <div class="bg-image w-100 h-100">
                        <div class="gradient flex-column d-flex justify-content-center align-items-center w-100 h-100">
            ...
            <article id="panel-4" class="w-100 h-100 bg-dark">
                <div class="panel">
                    <div class="bg-image w-100 h-100">
                        <div class="gradient flex-column d-flex justify-content-center align-items-center w-100 h-100">
                            <div class="text-center text-light col-10 py-5">
            ...
            <article id="panel-5" class="w-100 h-100 bg-dark">
                <div class="panel">
                    <div class="bg-image w-100 h-100">
                        <div class="gradient flex-column d-flex justify-content-center align-items-center w-100 h-100">
                            <div class="text-center text-light col-10 py-5">
                                <span class="display-6 muted">I work in</span>
