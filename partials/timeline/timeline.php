<div class="h-100 w-100 d-flex justify-content-center align-items-center text-center">
    <div class="py-5 col-10">
        <h2 class="display-5 display-lg-2 mb-2">My Experiences</h2>
        <p class="muted">
            To keep it short and relevant to my career field, the following periodization shows when and where my
            current knowledge come from.
        </p>
    </div>
</div>
...
<div class="relative timeline-container">
    <svg id="svg-stage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 1200">
        ...
        <text class="text01 role-list" x="90%" y="210">
            ...
            <tspan x="90%" dy=".3rem">> Frontend Dev</tspan>
        </text>

        <text class="text02" x="40" y="390">Dec 2023 - Mar 2024</text>
        <text class="title-2 title" y="410">
        ...
        <text class="text02 role-list" x="90%" y="410">
            ...
            <tspan x="91%" dy=".3rem">connection</tspan>
        </text>


        <text class="text03" x="40" y="590">Jun 2023 - Sept 2023</text>
        <text class="title-3 title" y="610">
        ...
        <text class="text03 role-list" x="90%" y="610">
            ...
            <tspan x="91%" dy=".3rem">creation</tspan>
        </text>

        <text class="text04" x="90%" y="790">2020 - 2023</text>
        <text class="title-4 title" y="815">
            <tspan dy=".5rem" x="87%">Software</tspan>
            <tspan dy=".5rem" x="87%">Engineering </tspan>
            <tspan dy=".5rem" x="87%">Student</tspan>
        </text>

        <text class="text05" x="30" y="990">Before 2019</text>
        <text class="title-5 title" y="1010">
            <tspan dy=".5rem" x="30">Scientific </tspan>
            <tspan dy=".5rem" x="30">Student</tspan>
        </text>
        ...
        <circle class="ball ball05" r="10" cx="135" cy="801"></circle>
        <circle class="ball ball06" r="10" cx="300" cy="1001"></circle>
